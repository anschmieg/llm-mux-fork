...
func GetGitHubCopilotModels() []*ModelInfo {
	return []*ModelInfo{
		...
		Copilot("claude-sonnet-4.5").Display("Claude Sonnet 4.5").Desc("Anthropic Claude Sonnet 4.5 via GitHub Copilot").Created(1763424000).Canonical("claude-sonnet-4-5").B(),
		Copilot("claude-haiku-4.5").Display("Claude Haiku 4.5").Desc("Anthropic Claude Haiku 4.5 via GitHub Copilot").Created(1763424000).Canonical("claude-haiku-4-5").B(),
		Copilot("claude-opus-4.5").Display("Claude Opus 4.5").Desc("Anthropic Claude Opus 4.5 via GitHub Copilot").Created(1763424000).Canonical("claude-opus-4-5").B(),
		...
		Copilot("oswe-vscode-prime").Display("OSWE VSCode Prime").Desc("Raptor Mini / OSWE VSCode Prime via GitHub Copilot").Created(1763424000).B(),
	}
}
